...
public class Result extends HttpServlet {
	...
	//	pw.println("<html>");
		...
		pw.println("<div style='padding:40px;margin-top:10%;height:45%;width:25%;background-color:white;margin-left:35%;'>");
		pw.println("<h1 style='color:#0f5866;margin-left:60px;'>"+"score "+a+" out of 5 "+"</h1>");
		if(a>=3)
		{
			pw.println("<h3 style='color:Green;margin-left:100px;'>Congratulations</h3>");
			pw.println("<h3 style='color:Green;margin-left:80px;'>! You Won The Quiz !</h3>");
			pw.println("<h4 style='color:Blue;margin-left:90px;'> Well Played</h4>");
		}
		else
		{
